          ...
          foreach($query as  $row){
            ...
            ?>
            	...
            	<td><a data-role="update" data-id="<?=$row['id']?>" href="#"><button class="btn btn-success">Düzenle</button></a></td>
                    <td><a class='btn btn-danger' href='ogretmenpanel.php?sil=<?php echo $row["id"]; ?>' role='button'>Sil</a></td>
     ...
     $('#save').click(function(e){
      ...
      var fen =  $('#fen').val();
       ...
       $.ajax({
         ...
         url    : 'ajax.php',
         method : 'post',
         data   : {ad : ad, soyad : soyad, alan : alan, sinif : sinif, turkce : turkce, sosyal : sosyal, matematik : matematik, fen : fen, id : 
         	id},
         success: function(e){
